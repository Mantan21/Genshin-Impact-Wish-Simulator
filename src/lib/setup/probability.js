...
for (let i = 0; i < 5; i++) base5StarChance.push(1.44); // 6-10
for (let i = 0; i < 5; i++) base5StarChance.push(1.47); // 11-15
for (let i = 0; i < 5; i++) base5StarChance.push(1.42); // 16-20
for (let i = 0; i < 5; i++) base5StarChance.push(1.6); // 21-25
for (let i = 0; i < 5; i++) base5StarChance.push(1.57); // 26-30
for (let i = 0; i < 10; i++) base5StarChance.push(1.51); // 31-40
for (let i = 0; i < 10; i++) base5StarChance.push(1.57); // 41-50
for (let i = 0; i < 10; i++) base5StarChance.push(1.31); // 51-60
for (let i = 0; i < 10; i++) base5StarChance.push(1.14); // 61-70
for (let i = 0; i < 3; i++) base5StarChance.push(0.8); // 71-73
